    ...
    def get_carros(cls):
        ...
        try:
            ...
            with connection.cursor() as cursor:
                cursor.execute("SELECT id, usuario_id, location, model, price, year, km, image_url FROM public.carros")
    ...
    def add_carro(cls, carro):
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute("""
                    INSERT INTO public.carros (usuario_id, location, model, price, year, km, image_url)
                    VALUES (%s, %s, %s, %s, %s, %s, %s)
                """, (carro.usuario_id, carro.location, carro.model, carro.price, carro.year, carro.km, carro.image_url))
        ...
        try:
            ...
            with connection.cursor() as cursor:
                cursor.execute("""
                    ...
                    SET usuario_id=%s, location=%s, model=%s, price=%s, year=%s, km=%s, image_url=%s
                    WHERE id = %s
                """, (carro.usuario_id, carro.location, carro.model, carro.price, carro.year, carro.km, carro.image_url, carro.id))
